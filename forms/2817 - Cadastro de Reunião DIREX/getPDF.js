...
function updatePDF(){
    ...
    if(state == 8 || state == 10){
        ...
        if(state == 8){
            ...
            console.log(itnsDIRAF)
            console.log(itnsDISUP)
            console.log(itnsDITEC)
            arrItns_Dir.push(itnsDISUP) 
            arrItns_Dir.push(itnsDIRAF) 
            arrItns_Dir.push(itnsDITEC) 
